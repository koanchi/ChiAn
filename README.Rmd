...
You can download the compendium as a zip from from this URL: <https://github.com/koanchi/ChiAn/archive/master.zip>

Or you can install this compendium as an R package, ChiAn, from GitHub with:
